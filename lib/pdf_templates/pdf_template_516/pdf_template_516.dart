...
class PdfTemplate516 extends PDFTemplate {
  ...
  void _buildPage1() {
    ...
    String temHour = insTem[7].split(':')[0];
    String temMin = insTem[7].split(':')[1];

    String year1 = ins[0] == '' ? '' : ins[0].split('/')[0];
    String month1 = ins[0] == '' ? '' : ins[0].split('/')[1];
    String day1 = ins[0] == '' ? '' : ins[0].split('/')[2];

    String year2 = ins[7] == '' ? '' : ins[7].split('/')[0];
    String month2 = ins[7] == '' ? '' : ins[7].split('/')[1];
    String day2 = ins[7] == '' ? '' : ins[7].split('/')[2];

    String year3 = ins[8] == '' ? '' : ins[8].split('/')[0];
    String month3 = ins[8] == '' ? '' : ins[8].split('/')[1];
    String day3 = ins[8] == '' ? '' : ins[8].split('/')[2];

    String year4 = ins[9] == '' ? '' : ins[9].split('/')[0];
    String month4 = ins[9] == '' ? '' : ins[9].split('/')[1];
    String day4 = ins[9] == '' ? '' : ins[9].split('/')[2];
          ...
          child: Column(
            ...
            children: [
                  ...
                  child: Table(tableWidth: TableWidth.min, children: [
                    TableRow(children: [
                      ...
                      Container(
                          ...
                          width: 150,
                          decoration: _buildBoxUnderLine(),
                          child: _buildText(ins[2], fontSize: 9)),
                    ]),
                    TableRow(children: [
                      ...
                      Container(
                          ...
                          width: 150,
                          decoration: _buildBoxUnderLine(),
                          child: _buildText(ins[3], fontSize: 9)),
                    ]),
                    TableRow(children: [
                      ...
                      Container(
                          ...
                          width: 150,
                          decoration: _buildBoxUnderLine(),
                          child: _buildText(ins[4], fontSize: 9)),
                    ]),
                    TableRow(children: [
                      ...
                      Container(
                          ...
                          width: 150,
                          decoration: _buildBoxUnderLine(),
                          child: _buildText(ins[5] + '  ' + ins[6] + '          印', fontSize: 9)),
                    ]),
                  ])),
              // ROW 2 Ⅰ．雇用契約期間
              Container(
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                _buildText(' その他 (' + ins[12] + ')', fontSize: 9),
              ]),
              // ROW 3 Ⅱ．就業の場所
              Container(
                  ...
                  child: Table(tableWidth: TableWidth.min, children: [
                    TableRow(children: [
                      ...
                      Container(
                          ...
                          width: 200,
                          decoration: _buildBoxUnderLine(),
                          child: _buildText(ins[14], fontSize: 9)),
                    ]),
                    TableRow(children: [
                      ...
                      Container(
                          ...
                          width: 200,
                          decoration: _buildBoxUnderLine(),
                          child: _buildText(ins[15], fontSize: 9)),
                    ]),
                    TableRow(children: [
                      ...
                      Container(
                          ...
                          width: 200,
                          decoration: _buildBoxUnderLine(),
                          child: _buildText(ins[16] == '' ? ',' : ins[16], fontSize: 9)),
                    ]),
                  ])),
              // ROW 4 Ⅲ．従事すべき業務の内容
              Container(
              ...
              Padding(
                ...
                child: _buildText('１ ． 分          野 （' + ins[17] + '）', fontSize: 9),
              ),
              Padding(
                padding: const EdgeInsets.fromLTRB(10, 0, 0, 0),
                child: _buildText('２ ． 業 務 区 分 （' + ins[18] + '）', fontSize: 9),
              ),
              // ROW 5 Ⅳ．労働時間等
              Container(
                margin: const EdgeInsets.only(top: 5),
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                _buildText(' 変形労働時間制：（' + ins[20] + '）単位の変形労働時間制', fontSize: 9),
              ]),
              Padding(
