        ...
        children: [
          ...
          Table(
            ...
            children: [
              ...
              _buildTableRow(_buildText('②食費として徴収する費用'), _buildText('１か月当たり 約  ' + (input1_3 ?? '') + '  円')),
              _buildTableRow(_buildText('③提供する食事，食材等の具体的な内容'), _buildText(input1_4 ?? ' ')),
              _buildTableRow(_buildText('④費用が実費に相当する額その他の適正な額であることの説明'), _buildText(input1_5 ?? ' ')),
            ],
          ),
          SizedBox(height: 8),
          ...
          Table(
            ...
            children: [
              ...
              _buildTableRow(_buildText('②居住費として徴収する費用'), _buildText('１か月当たり 約  ' + (input1_7 ?? '') + '  円')),
              _buildTableRow(_buildText('③提供する宿泊施設の具体的な内容'), _buildText((input1_8 ?? ' ') + '・' + (input1_9 ?? ''))),
              _buildTableRow(_buildText('④費用が実費に相当する額その他の適正な額であることの説明'), _buildText(input1_10 ?? ' ')),
            ],
          ),
          SizedBox(height: 8),
          _buildText('１ ②から④までは，①で有にチェックを付した場合にのみ記載すること。'),
  ...
  void _buildPage2() {
    _buildPage(Column(
      ...
      children: [
        ...
        Align(
          alignment: Alignment.centerRight,
          child: _buildText('作 成 責 任 者 役 職 ・ 氏 名    ' + (input2_18 ?? '') + ' ' + (input2_19 ?? '')),
        ),
      ],
    ));
  }
