        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
                ...
                children: [
                  pw.Column(
                      ...
                      children: [
                        pw.Padding(
                            ...
                            child: _buildText('別記第八十四号様式（第六十一条関係', font,
                                fontSize: 11)),
                        pw.Padding(
                            padding: const pw.EdgeInsets.fromLTRB(0, 0, 25, 0),
                            child: _buildText(
                                'Annex No. 84 (Related to Article 61)',
                                Font.times(),
                                fontSize: 10)),
                        pw.Padding(
                  ...
                  pw.Column(
                      ...
                      children: [
                        pw.Padding(
                            padding:
                                const pw.EdgeInsets.fromLTRB(0, 10, 0, 15)),
                        pw.Container(
                              ...
                              children: [
                                ...
                                pw.TableRow(
                                  children: [
                                    ...
                                    _buildText('Year', Font.times(),
                                        fontSize: 10),
                                    _buildText('', font, fontSize: 11),
                                    _buildText('Month', Font.times(),
                                        fontSize: 10),
                                    _buildText('', font, fontSize: 11),
                                    _buildText('Day', Font.times(),
                                        fontSize: 10),
                                  ],
                                ),
                              ]),
                                  ...
                                  children: [
                                    pw.TableRow(
                                      children: [
                                        ...
                                        _buildText('１,０００円', font,
                                            fontSize: 11,
                                            textAlign: TextAlign.center),
                                        _buildText('円 也 （￥１,０００円 ）', font,
                                            fontSize: 11,
                                            textAlign: TextAlign.center),
                                      ],
                                    ),
                                      ...
                                      children: [
                                        ...
                                        pw.Container(
                                          ...
                                          decoration: const pw.BoxDecoration(
                                              border: pw.Border(
                                                  bottom:
                                                      pw.BorderSide(width: 2))),
                                          child: _buildText('１,０００円', font,
                                              fontSize: 11,
                                              textAlign: TextAlign.center),
                                        )
                                      ],
                                      ...
                                      children: [
                                        ...
                                        pw.Column(
                                            crossAxisAlignment:
                                                pw.CrossAxisAlignment.stretch,
                                            children: [
                                              _buildText('永 住 許 可', font,
                                                  fontSize: 11,
                                                  textAlign: TextAlign.justify),
                                              _buildText('Permanent residence',
                                                  Font.times(),
                                                  fontSize: 10,
                                                  textAlign: TextAlign.justify),
                                            ])
              ...
              pw.Padding(
                  padding: const pw.EdgeInsets.fromLTRB(0, 0, 0, 0),
                  child: _buildText('（注）用紙の大きさは，日本産業規格Ａ列４番とする。', font,
                      fontSize: 11)),
              pw.Padding(
                  padding: const pw.EdgeInsets.fromLTRB(0, 0, 0, 0),
                  child: _buildText(
